...
export function vacina(props) {
    ...
    return (
        ...
        <Root>
            ...
            <DivEvent>
                <DivStatus>
                    <PEvent> Todas as vacinas estão em dia! </PEvent>
                    <AddVacina onClick={async () => {
                        const result = await CustomDialog(<CustomDialogVacina />, {
                            title: 'Cadastrar Vacina',
                            showCloseIcon: true,
                        });
                    }}> <ImageAdd2 src={addImg} /> </AddVacina>
                </DivStatus>

                <DivVacina>
                    <PVacina> V4 </PVacina>
                    <PDiaVacina> <b>Aplicado dia:</b> 16/02/2021</PDiaVacina>
                </DivVacina>
            </DivEvent>
